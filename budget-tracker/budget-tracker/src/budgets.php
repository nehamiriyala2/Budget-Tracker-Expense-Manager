...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->execute([$user_id, $category, $amount, $start_date, $end_date]);
...
<head>
    ...
    <style>
        ...
        @media (max-width: 576px) { h2 { font-size: 1.5rem; } .form-control { font-size: 0.9rem; } .btn-primary { font-size: 0.9rem; padding: 0.6rem; } .table { font-size: 0.85rem; } }
    </style>
</head>
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table">
                    <thead><tr><th>Category</th><th>Amount</th><th>Start Date</th><th>End Date</th></tr></thead>
                    <tbody><?php foreach ($budgets as $b): ?>
                        <tr><td><?php echo $b['category']; ?></td><td>₹<?php echo number_format($b['amount'], 2); ?></td><td><?php echo $b['start_date']; ?></td><td><?php echo $b['end_date']; ?></td></tr>

...
<head>
    ...
    <style>
        ...
        .login-container { max-width: 450px; width: 100%; padding: 2rem; animation: fadeInUp 0.8s ease-in-out; }
        .login-card { background: #ffffff; border-radius: 20px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1); padding: 2rem; transition: transform 0.3s ease; }
        .login-card:hover { transform: translateY(-5px); }
        .login-card h2 { color: #01579b; font-size: 2rem; font-weight: 600; text-align: center; margin-bottom: 1.5rem; animation: bounceIn 1s ease-in-out; }
        ...
        @media (max-width: 576px) { 
            ...
            .register-btn { font-size: 0.9rem; padding: 0.5rem 1rem; } 
        }
    </style>
</head>
<body>
    <div class="container mt-5 login-container">
        <div class="login-card">
            ...
            <a href="register.php" class="register-btn">Not Registered?</a>
        </div>
    </div>
</body>
</html>